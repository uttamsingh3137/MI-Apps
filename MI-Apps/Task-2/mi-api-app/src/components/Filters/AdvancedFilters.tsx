...
import {
  ...
  TitleInput,
  UserSelect,
} from "../../Styled/AdvancedFilters.styled";
...
import type { Props } from "../../Constants/Interfaces/AdvancedFilters.interface";
...
const AdvancedFilters: React.FC<Props> = ({
  ...
  const update = (field: keyof FilterValues, value: unknown) => {
    setFilters({
      ...filters,
      [field]: value,
    });
